(function ($) {
  ...
  $documentOn.ready( function() {
    ...
    var lastOpenTime = 0;
    var OPEN_COOLDOWN_MS = 500;
    function openOffcanvas() {
      if ($(".offcanvas__info").hasClass("info-open")) return;
      var now = Date.now();
    ...
    // Solution 2: Single document-level delegation, capture phase, no binding on hamburger
    ...
    // Close menu when clicking any link inside offcanvas (navigation, CTA, etc.)
    $(document).on("click", ".offcanvas__info.info-open a", function () {
      closeOffcanvas();
    });
    // ESC key closes menu
